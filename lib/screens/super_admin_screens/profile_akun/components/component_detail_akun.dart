...
class ComponenDetailAkunSuperAdmin extends StatefulWidget {
  const ComponenDetailAkunSuperAdmin({super.key});

  @override
  State<ComponenDetailAkunSuperAdmin> createState() =>
      _ComponenDetailAkunSuperAdminState();
}

class _ComponenDetailAkunSuperAdminState
    extends State<ComponenDetailAkunSuperAdmin> {
