...
import 'package:ns3_project/screens/juri_screens/akun/components/component_detail_akun.dart';
import 'package:ns3_project/service/session_guard.dart';
import 'package:ns3_project/components/text_format.dart';

class DetailProfileJuri extends StatelessWidget {
  const DetailProfileJuri({super.key});
  static String routeName = '/detail-profile-juri';
    ...
    return SafeArea(
      child: Column(
        children: [
          ...
          const Expanded(child: ComponenDetailAkunJuri()),
        ],
      ),
    );
  }
