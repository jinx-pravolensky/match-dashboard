...
class ComponentHalamanAkunJuri extends StatefulWidget {
  const ComponentHalamanAkunJuri({super.key});

  @override
  State<ComponentHalamanAkunJuri> createState() =>
      _ComponentHalamanAkunJuriState();
}

class _ComponentHalamanAkunJuriState extends State<ComponentHalamanAkunJuri> {
  String userName = "Juri Pertandingan";
              ...
              child: Column(
                children: [
                  _buildMenuItem(Icons.assignment_rounded, "Profil Saya", () {
                    Navigator.pushNamed(context, DetailProfileJuri.routeName);
                  }),
                  _buildMenuItem(
