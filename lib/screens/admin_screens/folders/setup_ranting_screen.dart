...
import 'package:ns3_project/screens/admin_screens/folders/tambah_juri_screen.dart';

class SetupRantingScreen extends StatefulWidget {
  final String matchId;
  final Map<String, dynamic> rantingData;

  const SetupRantingScreen({
    super.key,
  ...
  @override
  State<SetupRantingScreen> createState() => _SetupRantingScreenState();
}

class _SetupRantingScreenState extends State<SetupRantingScreen> {
  ...
  final List<String> kategoriList = ["Putra", "Putri", "Putra & Putri"];
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 15),
                const Text("Kategori Gender", style: text12greyBold),
                const SizedBox(height: 10),
                DropdownButtonFormField<String>(
                  decoration: _inputStyle(Icons.assignment_rounded),
                  hint: const Text(
                    "Pilih Kategori...",
                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                  ),
                  ...
                  selectedItemBuilder: (BuildContext context) {
                    return kategoriList.map<Widget>((String item) {
                      return Text(item, style: text14PrimaryBold);
                    }).toList();
                  },
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (selectedAmunisi == null ||
                          selectedKategori == null ||
                          !isRangkaianSet) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              "Harap lengkapi semua pilihan & Atur Rangkaian!",
                            ),
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TambahJuriScreen(
                            matchId: widget.matchId,
                            rantingData: widget.rantingData,
                            kaliberAmunisi: selectedAmunisi!,
                            seriesPerSession: seriesPerSession,
                            shotsPerSeries: shotsPerSeries,
                            kategoriGender: selectedKategori!,
                            skorDesimal: isDecimal,
                          ),
                        ),
                      );
                    },
                    child: const Text("Tambahkan Juri", style: text16WhiteBold),
                  ),
                ),
              ],
            ),
