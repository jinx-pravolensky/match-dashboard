...
class ComponentDataFolders extends StatefulWidget {
  const ComponentDataFolders({super.key});

  @override
  State<ComponentDataFolders> createState() => _ComponentDataFoldersState();
}

class _ComponentDataFoldersState extends State<ComponentDataFolders> {
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => FolderRantingScreen(
                                      matchId: match['_id'],
                                      matchTitle:
